...
//
//     // Simulated dummy response stream
//     const encoder = new TextEncoder();
//     const dummyChunks = [
//       `You asked: "${userPrompt}". `,
//       "Here's a helpful tip from the UVA Career Center. ",
//       "Be sure to explore our internships and resume workshops!",
//     ];
//
...
//       { error: err.message ?? "Mock LLM request failed" },
